...
❤️ Real-time learning using user feedback
✨ Features
...
🔹 1. Clone the repo
git clone https://github.com/ReallySanidhya/Personalized-Movie-Recommender.git
...
🔹 4. Prepare Data & Build Embeddings
...
Combines classic ML + modern AI
Handles cold-start problem
Includes explainable AI
Full end-to-end system (backend + frontend)
